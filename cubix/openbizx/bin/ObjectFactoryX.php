 ...
 * @version   $Id: ObjectFactory.php 3753 2012-07-29 15:25:13Z hellojixian@gmail.com $
 */
...
class ObjectFactory
{
    ...
    {
        //echo __METHOD__.'('.$objectName.')'.PHP_EOL;
    ...
    protected function constructObject($objName, &$xmlArr=null)
    {
        ...
        {        	
            if ( BizSystem::isCoreClass($class) && $classPackage !='service' ) {
                $classFile = BizSystem::getCoreLibFilePath($class);                
            } else {
