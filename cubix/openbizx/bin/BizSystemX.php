 ...
 * @version   $Id: BizSystem.php 3579 2012-07-10 07:29:46Z hellojixian@gmail.com $
 */
...
class BizSystem
{
    ...
    public function getObjectFactory()
    {
        ...
        {
            include_once(OPENBIZ_BIN."ObjectFactory.php"); // auto_load
    ...
    public function getSessionContext()
    {
        ...
        include_once(OPENBIZ_BIN."SessionContext.php"); // // auto_load
        $this->_sessionContext = new SessionContext();
        // retrieve object session vars
        $this->_sessionContext->retrieveSessionObjects();
        return $this->_sessionContext;
    ...
    public function getConfiguration()
    {
        ...
        {
            include_once(OPENBIZ_BIN."Configuration.php"); // auto_load
    ...
    public function getClientProxy()
    {
        ...
        {
            include_once(OPENBIZ_BIN."ClientProxy.php"); // auto_load
    ...
    public function getTypeManager()
    {
        ...
        {
            //include_once(OPENBIZ_BIN."TypeManager.php"); // auto_load
    ...
    {
        //echo __METHOD__ . '-' . $className . '-' . $packageName; 
    ...
    {
        return Resource::isCoreClass($className);
    }
