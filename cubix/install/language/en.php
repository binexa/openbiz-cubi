...
define('STR_OPENBIZ_PATH_FAIL',		'FAIL - OPENBIZ_PATH does not point to Openbiz installed path');
define('STR_ZEND_PATH',				'Zend Framework Path');
define('STR_ZEND_PATH_FAIL',		"FAIL - ZEND_FRWK_HOME doesn't point to Zend Framework installed path. Please modify ZEND_FRWK_HOME in ".OPENBIZ_PATH."/bin/sysheader_inc.php");
...
define('STR_DEFAULT_DATABASE_FILE',			'Default Database in '.OPENBIZ_APP_PATH.DIRECTORY_SEPARATOR.'<strong >application.xml</strong>');
