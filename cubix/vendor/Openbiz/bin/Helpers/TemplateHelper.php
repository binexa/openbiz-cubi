...
class TemplateHelper
{
    ...
    public static function getSmartyTemplate()
    {
        ...
        if ($useTheme) {
            ...
            $themePath = $theme;    // Openbiz::$app->getConfiguration()->GetThemePath($theme);
    ...
    public static function getTplFileWithPath($templateFile, $packageName)
    {
        ...
        $searchTpls = array(
            Openbiz::$app->getModulePath() . "/$packagePath/template/$templateFile",
            dirname(Openbiz::$app->getModulePath() . "/$packagePath") . "/template/$templateFile",
            Openbiz::$app->getModulePath() . "/$moduleName/template/$templateFile",
            //Openbiz::$app->getModulePath()."/common/template/$templateFile",
