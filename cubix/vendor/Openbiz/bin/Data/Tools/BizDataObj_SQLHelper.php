...
class BizDataObj_SQLHelper
{
    ...
    public function buildInsertSQL($dataObj, $joinValues = null)
    {
        ...
        $dbInfo = Openbiz::$app->getConfiguration()->getDatabaseInfo($dataObj->databaseAliasName);
...
function queryParamToRule($fieldName, $value, $dataObj)
{
    ...
    $val = Openbiz::$app->getTypeManager()->formattedStringToValue($bizField->type, $bizField->format, $val);
    // check " AND ", " OR "
