...
//        }
    ...
    public function getValue($formatted = true)
    {
        ...
        if ($this->format && $formatted) {
            $value = Openbiz::$app->getTypeManager()->valueToFormattedString($this->type, $this->format, $value);
        }
    ...
    {
        return Openbiz::getObject($this->bizDataObjName);
    }
    ...
    public function checkValueType($value = null)
    {
        ...
        $validator = Openbiz::getService(VALIDATE_SERVICE);
        switch ($this->type) {
            case "Number":
