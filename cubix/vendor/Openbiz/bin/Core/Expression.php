...
class Expression
{
    ...
    protected static function replaceVarExpr($expression, $object)
    {
        ...
        while (true) {
            ...
            if ($objName == "profile") {  // @profile:attribute is reserved
                $profileAttribute = Openbiz::$app->getUserProfile($propExpr);
            ...
            if ($objName == "home") {  // @home:url is reserved
                ...
                $serviceObj = Openbiz::getService($serviceName);
    ...
    public static function eval_syntax($code)
    {
        ...
        if ($b) {
            ...
            if ($r === false) {
                ...
                //Openbiz::$app->getLog()->log(LOG_ERR, "ERROR", "EVAL: $code. ".$error);
            }
            ob_end_clean();
    ...
    {
        if ($var == "profile") {
            return Openbiz::$app->getUserProfile($key);
        }
        return null;
    }
