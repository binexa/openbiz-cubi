...
class ColumnListbox extends OptionElement
{
	...
	{
		Openbiz::$app->getSessionContext()->loadObjVar($this->getFormObj()->objectName, $this->objectName, $this->value);
		...
		Openbiz::$app->getSessionContext()->saveObjVar($this->getFormObj()->objectName, $this->objectName, $this->value);
	}    
