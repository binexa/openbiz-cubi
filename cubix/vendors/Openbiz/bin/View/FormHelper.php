...
// -------------------------- Navigation Methods ---------------------- //
    ...
    {    	
		...
		if (!empty($output)) Openbiz::$app->getClientProxy()->redrawForm($this->formObj->objectName, $output);
    }
    ...
    {    	
		...
		$output = $formObj1->render();
		if (!empty($output)) Openbiz::$app->getClientProxy()->redrawForm("DIALOG", $output);
    }
