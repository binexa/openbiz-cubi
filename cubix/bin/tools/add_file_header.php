...
$module = $argv[1];
$moduleDir = Openbiz::$app->getModulePath().DIRECTORY_SEPARATOR.$module;
...
foreach ($files as $file) {
	...
	if (strpos($content, " * Openbiz Cubi Application Platform") === false) {
		...
		$packageName = str_replace("/",".",str_replace(Openbiz::$app->getModulePath().DIRECTORY_SEPARATOR,"",$path_parts['dirname']));
