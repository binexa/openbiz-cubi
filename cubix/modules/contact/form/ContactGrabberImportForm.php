...
class ContactGrabberImportForm extends EasyForm
{
    ...
    public function import()
    {
        ...
        $user_id = Openbiz::$app->getUserProfile("Id");
        $permOpt['group_id'] = Openbiz::$app->getUserProfile("default_group");
        ...
        switch ($recArr['type_selector']) {
            ...
            case '1': //create new type
                ...
                $contactTypeDO = Openbiz::getObject("contact.do.ContactTypeDO");
        ...
        $contactDO = Openbiz::getObject("contact.do.ContactDO");
