...
class NotificationWidgetForm extends EasyForm
{
    ...
    {
        $svc = Openbiz::getService("notification.lib.checkerService");
    ...
    public function MarkRead($id)
    {
        ...
        if ($rec['update_access']) {
            if (Openbiz::$app->allowUserAccess($rec['update_access'])) {
        ...
        if ($goto_url) {
            ...
            Openbiz::$app->getClientProxy()->redirectPage($goto_url);
        } else {
            Openbiz::$app->getClientProxy()->updateClientElement($this->objectName, "");
        }
    }
