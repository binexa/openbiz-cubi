...
{literal}  
		    ...
		    <Element Name="fld_create_by" 
		    		...
		    		FieldName="create_by" 
		    		Label="Create By" 
		    		Text="{Openbiz\Openbiz::$app->getProfile()->getProfileName(@:Elem[fld_create_by].Value)}"  
		    		Link="{APP_INDEX}/collab/contact_detail/{Openbiz\Openbiz::$app->getProfile()->getProfileId(@:Elem[fld_create_by].Value)}" 
		    		AllowURLParam="N"/>
		    ...
		    <Element Name="fld_update_by" 
		    		...
		    		FieldName="update_by" 
		    		Label="Update By"  
		    		Text="{Openbiz\Openbiz::$app->getProfile()->getProfileName(@:Elem[fld_update_by].Value)}"  
		    		Link="{APP_INDEX}/collab/contact_detail/{Openbiz\Openbiz::$app->getProfile()->getProfileId(@:Elem[fld_update_by].Value)}" 
		    		AllowURLParam="N"/>
